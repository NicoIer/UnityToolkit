    ...
    public class TelepathyClient : TelepathyListener
    {
...

        {
            ...
            catch (SocketException exception)
            {
                ...
                NetworkLogger.Info("Client Recv: failed to connect to ip=" + ip + " port=" + port + " reason=" + exception);
            }
            ...
            catch (Exception exception)
            {
                ...
                NetworkLogger.Error("Client Recv Exception: " + exception);
            }
        ...
        public bool Send(ArraySegment<byte> message)
        {
            if (Connected)
            {
                ...
                NetworkLogger.Error("Client.Send: message too big: " + message.Count + ". Limit: " + MaxMessageSize);
                return false;
            }

            NetworkLogger.Warning("Client.Send: not connected!");
            return false;
        }
