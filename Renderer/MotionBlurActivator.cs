...
namespace UnityToolkit
{
    ...
    {
        [Tooltip(
            "Scene View camera is named 'SceneCamera'. Inspector preview for materials, models, and prefabs is named 'Preview Scene Camera'. You can add your own custom cameras like MinimapCamera.")]
        [SerializeField]
        private string[] cameraBlacklist = new string[2] { "SceneCamera", "Preview Scene Camera" };
        ...
        public void OnCameraPreRender(ScriptableRenderContext context, Camera camera)
        {
            ...
            bool shouldBeActive = cameraBlacklist.Contains(camera.gameObject.name) == false && MotionBlurEnabled &&
        ...
        private bool FeatureNotReferenced()
        {
            ...
            if (notReferenced)
                Debug.LogError(
                    "MotionBlurKeywordHandler's motionBlurFeature is not referenced! Please assign it in inspector.",
                    gameObject);
